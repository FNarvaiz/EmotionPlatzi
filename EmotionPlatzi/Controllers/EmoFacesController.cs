...
namespace EmotionPlatzi.Controllers
{
    public class EmoFacesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,EmoPictureId,X,Y,Width,Heigth")] EmoFace emoFace)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,EmoPictureId,X,Y,Width,Heigth")] EmoFace emoFace)
        {
            if (ModelState.IsValid)
            {
